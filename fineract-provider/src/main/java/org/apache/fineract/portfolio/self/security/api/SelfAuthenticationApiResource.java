...
public class SelfAuthenticationApiResource {
    ...
    // TODO: @vidakovic this is really bad practice, resources should be standalone
    ...
    public String authenticate(@Context AppUser user, final String apiRequestBodyAsJson) {
        return this.authenticationApiResource.authenticate(user, apiRequestBodyAsJson, true);
    }
}
